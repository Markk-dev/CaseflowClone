...
<body class="Mode">
    ...
    <div class="charts-container d-flex">
        <div class="chart-item">
            <h3 style="font-weight: 650;">Total <span style="font-weight: 300;">Offenses</span></h3>
            <canvas id="total-offenses-chart"></canvas>
        </div>
        <div class="chart-item">
            <h3 style="font-weight: 650;">High Severity <span style="font-weight: 300;">Offenses</span></h3>
            <canvas id="high-offenses-chart"></canvas>
        </div>
    </div>
</div>
